...
public abstract class PhongHoc {
	...
	public void setMaPhong(String maPhong) {
		if(maPhong==null)
			throw new IllegalArgumentException("Ma phong k dc de trong");
	...
	public void setDayNha(String dayNha) {
		if(dayNha==null)
			throw new IllegalArgumentException("Day nha khong dc de trong");
		this.dayNha = dayNha;
	}
	...
	public void setSoBongDen(int soBongDen) {
		if(soBongDen<=0)
			throw new IllegalArgumentException("So bong den phai nhieu hon 0");
